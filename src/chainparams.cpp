...
{
    const char* pszTimestamp = "2016-08-20 10:06:35";
...
.3; // nPowTargetTimespan / nPowTargetSpacing
...
*/
        ...
        genesis = CreateGenesisBlock(1503213400, 666, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x498ee8c65c6443418a1ec38fa88989874b071b90833055ef665a779680bc8c08"));
        assert(genesis.hashMerkleRoot == uint256S("0xff01e05ed6280c6ac7572845f662c82dfe8d14cd3eb4af67420c808b8568e38f"));
